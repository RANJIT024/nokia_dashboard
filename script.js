document.addEventListener('DOMContentLoaded', () => {
    ...
    const screwDataSet = [
        ...
        { id: 19, angleMin: 3600, angleMax: 5500, actualAngle: 4450, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.3 },
       /* { id: 20, angleMin: 3600, angleMax: 5500, actualAngle: 3900, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.2 },
        { id: 21, angleMin: 3600, angleMax: 5500, actualAngle: 4750, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.4 },
        { id: 22, angleMin: 3600, angleMax: 5500, actualAngle: 5200, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.8 },
        { id: 23, angleMin: 3600, angleMax: 5500, actualAngle: 5000, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.7 },
        { id: 24, angleMin: 3600, angleMax: 5500, actualAngle: 4955, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.6 },
        { id: 25, angleMin: 3600, angleMax: 5500, actualAngle: 4700, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.5 },
        { id: 26, angleMin: 3600, angleMax: 5500, actualAngle: 4300, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.4 },
        { id: 27, angleMin: 3600, angleMax: 5500, actualAngle: 3900, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.2 },
        { id: 28, angleMin: 3600, angleMax: 5500, actualAngle: 3600, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.1 },
        { id: 29, angleMin: 3600, angleMax: 5500, actualAngle: 5500, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.9 },
        { id: 30, angleMin: 3600, angleMax: 5500, actualAngle: 4800, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.3 },
        { id: 31, angleMin: 3600, angleMax: 5500, actualAngle: 4701, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.5 },
        { id: 32, angleMin: 3600, angleMax: 5500, actualAngle: 5102, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.6 },
        { id: 33, angleMin: 3600, angleMax: 5500, actualAngle: 5299, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.8 },
        { id: 34, angleMin: 3600, angleMax: 5500, actualAngle: 4998, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.7 },
        { id: 35, angleMin: 3600, angleMax: 5500, actualAngle: 4755, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.6 },
        { id: 36, angleMin: 3600, angleMax: 5500, actualAngle: 4600, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.4 },
        { id: 37, angleMin: 3600, angleMax: 5500, actualAngle: 4500, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.3 },
        { id: 38, angleMin: 3600, angleMax: 5500, actualAngle: 3950, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.2 },
        { id: 39, angleMin: 3600, angleMax: 5500, actualAngle: 3650, torqueMin: 2.1, torqueMax: 2.8, actualTorque: 2.1 } */
    ];
    

    // Marker positions (approximated percentages for 19 screws)
    const markerPositions = [
        { id: 1, left: '46.80%', top: '64.80%' },
        { id: 2, left: '45.00%', top: '70.80%' },
        { id: 3, left: '38.00%', top: '67.80%' },
        { id: 4, left: '39.00%', top: '48.80%' },
        { id: 5, left: '49.00%', top: '48.80%' },
        { id: 6, left: '65.00%', top: '48.80%' },
        { id: 7, left: '82.00%', top: '49.80%' },
        { id: 8, left: '81.80%', top: '57.80%' },
        { id: 9, left: '81.80%', top: '66.80%' },
        { id: 10, left: '75.00%', top: '72.00%' },
        { id: 11, left: '64.00%', top: '71.00%' },
        { id: 12, left: '56.00%', top: '71.00%' },
        { id: 13, left: '25.00%', top: '68.80%' },
        { id: 14, left: '19.00%', top: '69.80%' },
        { id: 15, left: '20.00%', top: '48.80%' },
        { id: 16, left: '15.00%', top: '10.00%' },
        { id: 17, left: '29.00%', top: '10.00%' },
        { id: 18, left: '39.80%', top: '10.00%' },
        { id: 19, left: '60.80%', top: '10.00%' },
       /* { id: 20, left: '70.80%', top: '10.00%' },
        { id: 21, left: '82.80%', top: '10.00%' },
        { id: 22, left: '92.80%', top: '50.00%' },
        { id: 23, left: '92.80%', top: '59.00%' },
        { id: 24, left: '92.80%', top: '67.00%' },
        { id: 25, left: '85.80%', top: '73.00%' },
        { id: 26, left: '92.80%', top: '74.00%' },
        { id: 27, left: '85.80%', top: '83.00%' },
        { id: 28, left: '75.80%', top: '80.00%' },
        { id: 29, left: '64.80%', top: '83.00%' },
        { id: 30, left: '54.80%', top: '80.00%' },
        { id: 31, left: '39.80%', top: '10.00%' },
        { id: 32, left: '39.80%', top: '10.00%' },
        { id: 33, left: '39.80%', top: '10.00%' },
        { id: 34, left: '39.80%', top: '10.00%' },
        { id: 35, left: '39.80%', top: '10.00%' },
        { id: 36, left: '39.80%', top: '10.00%' },
        { id: 37, left: '39.80%', top: '10.00%' },
        { id: 38, left: '39.80%', top: '10.00%' },
        { id: 39, left: '39.80%', top: '10.00%' },*/
